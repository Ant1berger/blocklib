...
export default function Edit(props) {
    ...
    const { tag, persistentID, blockName, extremitiesDetector, otherAttributes, manualClasses, mediaQueries = [], renderedMediaQueries, anchor } = attributes;
    ...
    return (
        <Fragment>
            ...
            { React.createElement(
                ...
                extremitiesDetector && <span className='inline-scroll-startDetector'></span>,
                <InnerBlocks />,
                extremitiesDetector && <span className='inline-scroll-endDetector'></span>,
            ) }
        </Fragment>
    )
}
